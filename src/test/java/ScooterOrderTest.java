...
public class ScooterOrderTest {
    ...
    private final int numberOfOrderButton;
    ...
    public ScooterOrderTest(int numberOfOrderButton, String userName, String userSurname, String userAddress, String userMetroStation,
    ...
    public static Object[][] getOrderData() {
        return new Object[][] {
                {0, "Иван", "Иванов", "ул. Седова 66", "Черкизовская", "+79041112233", "27.11.2022", 2, 0, "Не поскользнись", "Заказ оформлен"},
                {1, "Петр", "Петров", "ул. Победы 77", "Сокольники", "+79064445566", "28.11.2022", 3, 1, "Не опаздай", "Заказ оформлен"},
        };
    }
    ...
    public void orderScooterUsingHeaderButton() {
        ...
        // прокрутить до нужной кнопки "Заказать" из списка кнопок
        objScooterHomePage.scrollDownToTheElementFromTheList(numberOfOrderButton, objScooterHomePage.getListOfOrderButtons());
        // нажатие на кнопку "Заказать" из списка
        objScooterHomePage.clickOnTheElementFromTheList(numberOfOrderButton, objScooterHomePage.getListOfOrderButtons());
        ...
        objUserInformationPage.clickToTheElement(objUserInformationPage.getButtonNext());
        ...
        objOrderDetailsPage.clickToTheElement(objOrderDetailsPage.getButtonOrder());
        // кликнуть по кнопке "Да" на поп-апе "Хотите офрмить заказ"
        objOrderDetailsPage.clickToTheElement(objOrderDetailsPage.getButtonOrderConfimation());
